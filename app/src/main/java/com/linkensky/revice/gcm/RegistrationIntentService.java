...
//            subscribeTopics(token);
            ...
            sharedPreferences.edit().putBoolean(RevicePreferences.SENT_TOKEN_TO_SERVER, false).apply();
        }
        // Notify UI that registration has completed, so the progress indicator can be hidden.
        Intent registrationComplete = new Intent(RevicePreferences.REGISTRATION_COMPLETE);
        ...
        tokenCall.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if(response.isSuccess()){
                    sharedPreferences.edit().putBoolean(RevicePreferences.SENT_TOKEN_TO_SERVER, true).apply();
                }else{
                    sharedPreferences.edit().putBoolean(RevicePreferences.SENT_TOKEN_TO_SERVER, false).apply();
                }
            }
